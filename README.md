...
> AST-powered semantic post-processor for Repomix. Reduces LLM context token consumption by 60% - 80% while preserving 100% schema integrity, types, and core logic.
...
- **Full Schema Integrity**: TypeScript interfaces, type aliases, classes, and parameter contracts are 100% preserved.
